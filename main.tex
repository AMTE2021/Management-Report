...
\subsection{Keynote}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
On using modern C++ and nested recursive task parallelism for HPC applications with AllScale, Thomas Fahringer, Institute of Computer Science, University of Innsbruck, Austria
    \begin{center}
        \textbf{Abstract}
    \end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The Past, Present, and Future of Asynchrony in C++,  Daisy S. Hollman, Google, USA
    \begin{center}
        \textbf{Abstract}
    \end{center}
